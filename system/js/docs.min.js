/**
 * Created by Администратор on 01.08.15.
 */
/*!

 Holder - client side image placeholders
 Version 2.4.1+f2l1h
 В© 2014 Ivan Malopinsky - http://imsky.co
...
!function (a, b, c) {
    ...
    function f(a, b, c, d) {
        ...
        if ({text: h.text, width: h.width, height: h.height, textHeight: h.font.size, font: h.font.family, fontWeight: h.font.weight, template: h.theme}, f = e(), null == f)throw"Holder: couldn't render placeholder";
...
/*            }), a("#exampleModal").on("show.bs.modal", function (b) {
                ...
                var c = a(b.relatedTarget), d = c.data("names"), e = a(this);
                e.find(".transfer").val(d) /*e.find(".modal-body input").val(d)*/
...
/*Управление модалью удаления дилера*/
    $('#deleteDillModal').on('show.bs.modal', function (event) {
        ...
        var companyName = $('#'+idDill).find('.company').text();
        var modal = $(this)
